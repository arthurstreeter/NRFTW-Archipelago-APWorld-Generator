export const optionsData = [
    ...
    },
    {
        ...
        options: [
            ...
            { name: "pool_resource", type: "toggle", default: 0, label: "Pool: Resources" },
            { name: "pool_refined_resource", type: "toggle", default: 0, label: "Pool: Refined Resources" },
            { name: "pool_material", type: "toggle", default: 0, label: "Pool: Materials" },
            { name: "pool_recipe", type: "toggle", default: 0, label: "Pool: Recipes" },
            { name: "pool_rune", type: "toggle", default: 0, label: "Pool: Runes" },
            { name: "pool_gem", type: "toggle", default: 0, label: "Pool: Gems" },
            { name: "pool_house_item", type: "toggle", default: 0, label: "Pool: House Items" },
            { name: "pool_quiver", type: "toggle", default: 0, label: "Pool: Quivers" },
